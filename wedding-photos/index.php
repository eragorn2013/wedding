			...
			<div class="container">
				<div class="content card-all-content">
					<div class="card-all-left">
						<div class="card-all-left-all-photos">
							<h1 class="card-all-left-all-photos-head head-left-h">3400 Фото</h1>
							<div class="card-all-left-all-photos-wrap">								
								<a class="card-all-left-all-photos-item" href="img/portfolio/1.webp">
									<img class="card-all-left-all-photos-item-img" src="img/portfolio/1.webp" alt="">
									<span class="card-all-left-all-photos-item-info">
										<span class="card-all-left-all-photos-item-info-wrap">
											<span class="card-all-left-all-photos-item-info-date">23.11.2020</span>
											<span class="card-all-left-all-photos-item-info-name">Свадьба Маши и Пети</span>
											<span class="card-all-left-all-photos-item-info-geo">Загородный клуб Трампампам</span>
										</span>
									</span>
								</a>
								<a class="card-all-left-all-photos-item" href="img/portfolio/2.webp">
									<img class="card-all-left-all-photos-item-img" src="img/portfolio/2.webp" alt="">
									<span class="card-all-left-all-photos-item-info">
										<span class="card-all-left-all-photos-item-info-wrap">
											<span class="card-all-left-all-photos-item-info-date">23.11.2020</span>
											<span class="card-all-left-all-photos-item-info-name">Свадьба Маши и Пети</span>
								...
								<a class="card-all-left-all-photos-item" href="img/portfolio/3.webp">
									<img class="card-all-left-all-photos-item-img" src="img/portfolio/3.webp" alt="">
									<span class="card-all-left-all-photos-item-info">
										<span class="card-all-left-all-photos-item-info-wrap">
											<span class="card-all-left-all-photos-item-info-date">23.11.2020</span>
											<span class="card-all-left-all-photos-item-info-name">Свадьба Маши и Пети</span>
								...
								<a class="card-all-left-all-photos-item" href="img/portfolio/4.webp">
									<img class="card-all-left-all-photos-item-img" src="img/portfolio/4.webp" alt="">
									<span class="card-all-left-all-photos-item-info">
										<span class="card-all-left-all-photos-item-info-wrap">
											<span class="card-all-left-all-photos-item-info-date">23.11.2020</span>
											<span class="card-all-left-all-photos-item-info-name">Свадьба Маши и Пети</span>
							...
							<a class="card-all-left-all-photos-more" href="#">Показать еще</a>
						</div>
						<div class="card-all-left-flow">
							<h2 class="card-all-left-flow-head head-left-h">Фотопоток</h2>
							<div class="card-all-left-flow-wrap">
								<div class="card-all-left-flow-col first">
									<a class="card-all-left-flow-col-item big" href="img/favorites/2.webp">
										<img class="card-all-left-flow-col-item-img" src="img/favorites/2.webp" alt="">
									</a>
									<a class="card-all-left-flow-col-item small" href="img/favorites/1.webp">
										<img class="card-all-left-flow-col-item-img" src="img/favorites/1.webp" alt="">
									</a>
									<a class="card-all-left-flow-col-item small" href="img/favorites/3.webp">
										<img class="card-all-left-flow-col-item-img" src="img/favorites/3.webp" alt="">
									</a>
									<a class="card-all-left-flow-col-item small" href="img/favorites/6.webp">
										<img class="card-all-left-flow-col-item-img" src="img/favorites/6.webp" alt="">
									</a>
									<a class="card-all-left-flow-col-item small" href="img/favorites/5.webp">
										<img class="card-all-left-flow-col-item-img" src="img/favorites/5.webp" alt="">
									</a>							
								</div>
								<div class="card-all-left-flow-col second">
									<a class="card-all-left-flow-col-item small" href="img/favorites/4.webp">
										<img class="card-all-left-flow-col-item-img" src="img/favorites/4.webp" alt="">
									</a>
									<a class="card-all-left-flow-col-item small" href="img/favorites/1.webp">
										<img class="card-all-left-flow-col-item-img" src="img/favorites/1.webp" alt="">
									</a>
									...
									<a class="card-all-left-flow-col-item big" href="img/favorites/5.webp">
										<img class="card-all-left-flow-col-item-img" src="img/favorites/5.webp" alt="">
									</a>	
								</div>
							</div>
						...
						<div class="card-all-left-services">
							<h2 class="card-all-left-services-head head-left-h">Услуги:</h2>
