				...
				<div class="content card-all-content">
					<div class="card-all-left">
						...
						<div class="card-all-left-images">
							<h3 class="card-all-left-images-head head-left">Фотопоток</h3>
							<div class="card-all-left-images-wrap portfolio-wrap">
								<a class="card-all-left-images-item-alternative" href="img/portfolio/1<?= $expansion ?>">
									<img class="card-all-left-images-item-img" src="img/portfolio/1<?= $expansion ?>" alt="">
								</a>
								<a class="card-all-left-images-item-alternative" href="img/portfolio/2<?= $expansion ?>">
									<img class="card-all-left-images-item-img" src="img/portfolio/2<?= $expansion ?>" alt="">
								</a>
								<a class="card-all-left-images-item-alternative" href="img/portfolio/3<?= $expansion ?>">
									<img class="card-all-left-images-item-img" src="img/portfolio/3<?= $expansion ?>" alt="">
								</a>
								<a class="card-all-left-images-item-alternative" href="img/portfolio/4<?= $expansion ?>">
									<img class="card-all-left-images-item-img" src="img/portfolio/4<?= $expansion ?>" alt="">
								</a>
								<a class="card-all-left-images-item-alternative" href="img/portfolio/5<?= $expansion ?>">
									<img class="card-all-left-images-item-img" src="img/portfolio/5<?= $expansion ?>" alt="">
								</a>
								<a class="card-all-left-images-item-alternative" href="img/portfolio/6<?= $expansion ?>">
							...
							<a class="card-all-left-images-more" href="#">Загрузить еще</a>
						</div>						
